class FavoriteListModel {
  List<FavoriteListResult>? result;
  String? message;
  String? status;

  FavoriteListModel({this.result, this.message, this.status});

  FavoriteListModel.fromJson(Map<String, dynamic> json) {
    if (json['result'] != null) {
      result = <FavoriteListResult>[];
      json['result'].forEach((v) {
        result!.add(new FavoriteListResult.fromJson(v));
      });
    }
...
class FavoriteListResult {
  ...
  FavoriteListResult.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    type = json['type'];
    name = json['name'];
    mobile = json['mobile'];
