class MentorListModel {
  List<MentorListResult>? result;
  String? message;
  String? status;

  MentorListModel({this.result, this.message, this.status});

  MentorListModel.fromJson(Map<String, dynamic> json) {
    if (json['result'] != null) {
      result = <MentorListResult>[];
      json['result'].forEach((v) {
        result!.add(new MentorListResult.fromJson(v));
      });
    }
...
class MentorListResult {
  ...
  MentorListResult.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    type = json['type'];
    name = json['name'];
    mobile = json['mobile'];
